...
export function NotificationCard({ notification, onClose, closable = true, large = false }) {
...
export function NotificationModal({ notification, onClose, closable = true, large = false }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
      <NotificationCard notification={notification} onClose={onClose} closable={closable} large={large} />
    </div>
  );
}
